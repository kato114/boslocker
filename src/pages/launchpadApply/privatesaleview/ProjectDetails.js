  ...
  const countdownrender = ({ days, hours, minutes, seconds, completed }) => {
    if (completed) {
      ...
      return (
        <ul>
          <li>
            <span id="days">{zeroPad(days, 2)} </span>Days
          </li>
          <li>
            <span id="hours">{zeroPad(hours, 2)}</span>Hours
          </li>
          <li>
            <span id="minutes">{zeroPad(minutes, 2)}</span>Minutes
          </li>
          <li>
            <span id="seconds">{zeroPad(seconds, 2)}</span>Seconds
          </li>
        </ul>
      );
    }
